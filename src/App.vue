<template>
    <div
        class="grid layout h-screen font-sans dark:text-gray-900 max-w-screen-lg lg:max-w-full"
    >
        <AppHeader />
        <Sidebar />
        ...
        <FlexMarkup v-else />
        <footer
            class="footer dark:bg-white flex items-center justify-center border-t dark:border-gray-200"
        >
            <a
                href="http://localhost:5173"
                target="_blank"
                rel="noopener noreferrer"
                title="A project by dratyti22"
